...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.rememberMe().tokenRepository(null).tokenValiditySeconds(604800);
	...
	public PersistentTokenRepository persitPersistentTokenRepository() {
		JdbcTokenRepositoryImpl jdTokenRepositoryImpl = new JdbcTokenRepositoryImpl();
		jdTokenRepositoryImpl.setDataSource(dataSource);
		return jdTokenRepositoryImpl;
