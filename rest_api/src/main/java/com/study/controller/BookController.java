...
public class BookController {
	...
	public ResponseEntity<List<BookDTO>> list(){ //ResponseEntity : 데이터를 객체로 담아서 상태코드로 다시 return 가능
	...
	public ResponseEntity<BookDTO> get(@PathVariable("code") int code){
		return new ResponseEntity<BookDTO>(service.select(code),HttpStatus.OK);
	}
	
	// /book/1000 + DELETE ==> 성공시 success, 싪패시 fail
	...
	// /book/1000 + PUT + body(수정내용-json형태)
