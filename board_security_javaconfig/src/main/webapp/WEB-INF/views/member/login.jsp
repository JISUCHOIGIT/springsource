...
<%--
	...
	2) userid를 입력받는 부분의 name = "username"으로 반드시 지정
	3) 비밀번호를 입력받는 부분의 요소 명은  name = "password" 으로 반드시 지정
		...
		<div class="row">
			<form action="/login" method="post" class="form-signin">
				...
				<div class="error-message">
					<span>${loginError}</span> <!-- 컨트롤러 : loginError model 객체로 담음 -->
				</div>
			</form>	
		</div>
	</div>
